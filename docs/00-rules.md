...
2. `brainstorming/` — `system-design.md` (তিন পথ · FAANG-এ কী ভালো)
...
- `৪৫′` = মিনিট।
- `(ডক ১৩)` = এই সাইটের ডক; `(sim url-shortener · scalable)` = simulator-এর সিস্টেম আর লেভেল। কাজের নিচে লিংক।
