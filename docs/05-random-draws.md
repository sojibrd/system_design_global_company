...
- [ ] ২৫′ mock #২-এর "একটা জিনিস" (plan-এর system design mock; mock না হলে সবচেয়ে দুর্বল ৪৫′-এর রেকর্ডিং থেকে একটা জিনিস) — শুধু ওটা: ঐ অংশটা অন্য একটা সিস্টেমে, ১০ মিনিটে, রেকর্ড 🧠 (Deliberate practice)
